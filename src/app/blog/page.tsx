// No "use client" — this is now a Server Component. The static shell
// (headings, copy, links, the widget's container div) renders on the server;
// only the decorative blob animation and the widget's shadow-DOM style
// injector hydrate as client islands.
...
// Real, server-rendered metadata — visible to crawlers and link-unfurlers
// immediately, unlike the widget's own client-side document.title trick.
