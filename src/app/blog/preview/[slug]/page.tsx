// src/app/blog/preview/[slug]/page.tsx
"use client";

import { Suspense, useState, useEffect } from "react";
import Link from "next/link";
import { useParams, useSearchParams } from "next/navigation";
import { ChevronLeft, Share2, Check, Copy, Flame, Eye, FileText } from "lucide-react";
...
function BlogPreviewContent() {
  ...
  const handleShareTwitter = () => {
    if (typeof window !== "undefined") {
      const text = encodeURIComponent("Previewing draft post on Masterstroke Academy!");
